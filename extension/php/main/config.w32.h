...
/* Configure line */
#define CONFIGURE_COMMAND "cscript /nologo configure.js  \"--enable-snapshot-build\" \"--disable-isapi\"" " \"--enable-debug-pack\" \"--disable-isapi\" \"--without-mssql\" \"--without-pdo-mssql\"" " \"--without-pi3web\" \"--enable-com-dotnet\" \"--with-gd\" \"--with-curl\"" " \"--enable-zlib\" \"--with-iconv\""
